...
import { CandidateIndex, CellIndex, CellValue, valueBit } from '../SolveUtility';
...
export function* generateLEWeakLinks(size: number, cellIndex1: CellIndex, cellIndex2: CellIndex, k: number): Generator<[CandidateIndex, CandidateIndex]> {
