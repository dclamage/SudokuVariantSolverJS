...
import * as KropkiConstraint from './KropkiConstraint';
...
import * as SumConstraint from './SumConstraint';
...
export function registerAllConstraints(constraintBuilder: ConstraintBuilder) {
    ...
    KropkiConstraint.register(constraintBuilder);
    ...
    SumConstraint.register(constraintBuilder);
